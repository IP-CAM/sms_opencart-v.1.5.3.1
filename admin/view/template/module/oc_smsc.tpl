...
<div class="content">
	...
	<form action="<?php echo $url_action ?>" method="post" enctype="multipart/form-data" id="setting-form">
		...
		<div class="tab-inner-form2">
			...
			<p>
			<label>
				<?php echo $oc_smsc_label_customer_new_status ?><br />
				<textarea cols=50 rows=3 name="oc_smsc_textarea_customer_new_status"><?php echo (!empty($value_oc_smsc_textarea_customer_new_status) ? $value_oc_smsc_textarea_customer_new_status : $oc_smsc_message_customer_new_order_status) ?></textarea>
			</label>
			</p>
